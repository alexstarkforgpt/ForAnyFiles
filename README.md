...
### Посмотреть привязанную почту

Открыть <https://github.com/settings/emails>. На этой странице показаны все адреса, привязанные к аккаунту, а в поле **Primary email address** — основной адрес. У основного адреса должен быть статус **Verified**.
